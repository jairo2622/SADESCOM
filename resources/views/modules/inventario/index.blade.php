...
@section('contenido')
    ...
    <div class="container">
        ...
        <section>
            <table class="table table-bordered text-center shadow tabla_inventario table_apartados">
                            ...
                            <td>
                                <form action="{{ route('destroyinventario', $item->id) }}" method="post">
                                    ...
                                    <button class="btn btn-danger d-inline-flex align-items-center gap-1" type="submit"
                                        onclick="return ConfirmarEliminacionProductos()"><svg xmlns="http://www.w3.org/2000/svg"
